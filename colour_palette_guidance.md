...
### Guidance from DfT
[R Shiny app that allows you to select colours and see if they meet colour contrast regulations](https://fran-bryden-dft.shinyapps.io/chart_accessibility-main/). It also allows you to check what it looks like in black and white.But unsure if the checker tool is checker whether or not the contrast between the colour and the white background meets the regulations. 
